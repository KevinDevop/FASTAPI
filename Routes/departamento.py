...
async def GetFindDepartamentoComplete(id_dep: int, db: Session = Depends(get_db)):
    ...
    return BSC_DEPARTAMENTO_PAISSchema(ID_DEPARTAMENTO=departamento.id_departamento, NOMBRE_DEPARTAMENTO=departamento.nombre_departamento, NOMBRE_PAIS=pais.nomb_pais)
